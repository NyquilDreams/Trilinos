...
namespace Tpetra {
                         ...
                         const ImpView& imports)
  {
    ...
    actor_.doPostsAndWaitsKokkos(plan_, exports, numPackets, imports);
  }
  ...
  doPostsKokkos (const ExpView &exports,
                 ...
                 const ImpView &imports)
  {
    actor_.doPostsKokkos(plan_, exports, numPackets, imports);
  }
  ...
  doReversePostsAndWaitsKokkos (const ExpView& exports,
                                ...
                                const ImpView& imports)
  {
    doReversePostsKokkos (exports, numPackets, imports);
    doReverseWaits ();
  }
                        ...
                        const  ImpView &imports)
  {
    ...
    reverseDistributor_->doPostsKokkos (exports, numPackets, imports);
  }
